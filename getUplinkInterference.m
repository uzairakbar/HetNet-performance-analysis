function [interference_dB] = getUplinkInterference(tier, power_db_array, max_power, nUS_0, nUS_1, nUS_2)
...
if tier == 0
    powers = power_db_array(1:nUS_0);
elseif tier == 1
    powers = power_db_array(nBS_0+1:nUS_1);
elseif tier == 2
    powers = power_db_array(nBS_1+1:nUS_2);
end
